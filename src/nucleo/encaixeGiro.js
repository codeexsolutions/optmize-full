 ...
 *
 * Portado de `public/encaixe-giro.js` sem mudar uma linha: entraram os
 * `export`. A cópia de lá continua servindo a tela antiga até o Encaixe migrar.
 */

export const ROTACOES_POR_GIRO = { "180": [0, 180], fixa: [0], livre: [0, 90, 180, 270] };

/** As posições que vale a pena tentar para esta peça. */
export const rotacoesDe = (item) => ROTACOES_POR_GIRO[item.giro] || [0];

/** Só o modo "livre" pode trocar largura por altura no encaixe por retângulo. */
export const podeDeitar = (item) => item.giro === "livre";
