 ...
 * SERVIDOR — `impressoras/../encaixe-memoria.js` o carrega por `require()`
 * para treinar a rede a partir do que ficou guardado.
 *
 * Por isso a cópia de `public/encaixe-rede.js` continua existindo e continua
 * terminando com o guard de `module.exports`: é ela que o Node carrega. Esta
 * aqui é a do navegador. **Mexeu numa, mexe na outra.**
 *
