 ...
 * documento sempre. Só que existe tela em que ele atrapalha e a rota não tem
 * como saber:
 *
 ...
 *
 * Mora num arquivo próprio, e não dentro da `Casca`, para que qualquer tela
 * possa pedir sem importar a casca que a desenha — o caminho curto para um
 * ciclo de importação, que o empacotador aceita e que quebra na ordem errada
 * de inicialização, do jeito mais difícil de achar.
 */
