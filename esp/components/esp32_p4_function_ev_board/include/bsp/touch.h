...
/**
 * @brief O controlador de toque que o BSP criou, ou NULL se ainda nao criou.
 *
 * ACRESCENTADO: nao existe no BSP original. Necessario para espelhar o toque
 * quando a tela e girada -- ver o comentario na implementacao.
 */
