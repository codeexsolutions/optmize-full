...
/* ===========================================================================
 * A PLACA NAO E A DA ESPRESSIF -- e uma Waveshare ESP32-P4-WIFI6-Touch-LCD-7B
 * ===========================================================================
 *
 * Este BSP e da ESP32-P4-Function-EV-Board. A placa aqui e outra, de outro
 * fabricante, e os pinos da tela sao outros. Valores conferidos no suporte
 * dessa placa no projeto xiaozhi-esp32
 * (main/boards/waveshare/esp32-p4-wifi6-touch-lcd/config.h, bloco
 * CONFIG_BOARD_TYPE_WAVESHARE_ESP32_P4_WIFI6_TOUCH_LCD_7B):
 *
 *     PIN_NUM_LCD_RST        GPIO_NUM_33   (o BSP dizia 27)
 *     DISPLAY_BACKLIGHT_PIN  GPIO_NUM_32   (o BSP dizia 26)
 *     BACKLIGHT_OUTPUT_INVERT true         (acende em nivel BAIXO)
 *     LANE_BITRATE_MBPS      900           (o BSP usa 1000)
 *
 * O reset e o que mais importa: no pino errado o painel nunca sai do estado
 * inicial e ignora tudo que chega pelo DSI -- inclusive o padrao de barras
 * gerado pelo proprio silicio. E o que explica a tela morta com todo o resto
 * reportando sucesso.
 */
