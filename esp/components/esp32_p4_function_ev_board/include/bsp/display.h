...
/* 900 e o valor desta placa Waveshare 7B; 1000 era o da placa da Espressif. */
...
/**
 * @brief O painel que o BSP criou, ou NULL se ainda nao criou.
 *
 * ACRESCENTADO: nao existe no BSP original. Para quem precisa do painel direto
 * -- espelhar, girar -- sem pagar o custo do caminho do LVGL.
 */
